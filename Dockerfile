...
then export ver=3; else export ver=3.9; add-apt-repository ppa:deadsnakes/ppa; sed -i "s/$DISTRIBUTION/jammy/g" "/etc/apt/sources.list.d/deadsnakes-ubuntu-ppa-$DISTRIBUTION.list"; fi; \
apt-get update; \
