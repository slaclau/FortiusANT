...
-r requirements.txt
RUN sudo apt-get install -y debhelper dh-virtualenv libgstreamer-plugins-base1.0-0 libnotify4 libsdl2-2.0-0 libwebkit2gtk-4.0-dev libjavascriptcoregtk-4.0-dev libegl-dev