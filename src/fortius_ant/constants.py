...
help_R = (
    "The runoff procedure can be customized: maxSpeed/dip/minSpeed/targetTime/power."
)
help_a = (
    "Automatically start; “Locate HW” and “Start” if the required devices were found."
)
