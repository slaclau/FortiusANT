...
class clsTcxExport:
    ...
    def TrackpointX(self, TacxTrainer, HeartRate):
        ...
        # -----------------------------------------------------------------------
            ...
            # -------------------------------------------------------------------
            if (
                HeartRate != self.TrackpointHeartRate
                ...
                # ---------------------------------------------------------------
                if (
                    self.TrackpointXwritten > 0
                    and self.TrackpointXwritten < time.time() - 300
                ):
    ...
    def Trackpoint(
        ...
        if Latitude != None:
            s += TcxPosition % (float(Latitude), float(Longitude))
        if Altitude != None:
            s += TcxAltitude % (float(Altitude))
        ...
        if Watts != None:
            s += TcxWattSpeed % (int(Watts), float(SpeedKmh))
    ...
    def Stop(self):
        ...
        self.tcx = (
            TcxActivities
            % (
                self.TcxTime(self.StartTime) + " @ FortiusANT ",
